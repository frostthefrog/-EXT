...
-- _G Globals
local COLOR_LIGHT_GREEN				= LocalDrawColor(20, 255, 255, 255);
local COLOR_ORANGE_RED				= LocalDrawColor(190, 255, 69, 0);
local COLOR_WHITE					= LocalDrawColor(190, 255, 255, 255);
local COLOR_BLACK					= LocalDrawColor(190, 0, 0, 0);
local COLOR_RED						= LocalDrawColor(190, 255, 0, 0);
local COLOR_YELLOW					= LocalDrawColor(190, 255, 255, 0);
