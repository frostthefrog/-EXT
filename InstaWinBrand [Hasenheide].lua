...
function Brand:Draw()
    ...
    if Brand.draw.harassKey:Value() then
		if Brand.harass.harassKey:Value() then
			Draw.Text("HARASS ON",  15, heroPos2D.x - 82, heroPos2D.y - -40, Draw.Color(200, 000, 255, 000)) 
		else
			Draw.Text("HARASS OFF", 15, heroPos2D.x - 82, heroPos2D.y - -40, Draw.Color(200, 255, 000, 000)) 
		end
	end
    if Brand.draw.clearKey:Value() then
		if Brand.clear.clearKey:Value() then
			Draw.Text("CLEAR ON",   15, heroPos2D.x + 10, heroPos2D.y - -40, Draw.Color(200, 000, 255, 000)) 
		else
			Draw.Text("CLEAR OFF",  15, heroPos2D.x + 10, heroPos2D.y - -40, Draw.Color(200, 255, 000, 000)) 
		end
    end
