	...
	if QData.level > 0 then
		...
		if QData.ammoCurrentCd > 0 then
			...
			if QData.currentCd > 0 then
				...
				Draw.Rect(hero.pos2D.x-XposX+3+27*0,hero.pos2D.y+YposY+3+16,23,4,Draw.Color(0xFF339900));
				end;
			end
		end
	...
	if WData.level > 0 then
		...
		if WData.ammoCurrentCd > 0 then
			...
			if WData.currentCd > 0 then
				...
				Draw.Rect(hero.pos2D.x-XposX+3+27*1,hero.pos2D.y+YposY+3+16,23,4,Draw.Color(0xFF339900));
				end;
			end;
		end
	...
	if EData.level > 0 then
		...
		if EData.ammoCurrentCd > 0 then
			...
			if EData.currentCd > 0 then
				...
				Draw.Rect(hero.pos2D.x-XposX+3+27*2,hero.pos2D.y+YposY+3+16,23,4,Draw.Color(0xFF339900));
				end;
			end;
		end
	...
	if RData.level > 0 then
		...
		if RData.ammoCurrentCd > 0 then
			...
			if RData.currentCd > 0 then
				...
				Draw.Rect(hero.pos2D.x-XposX+3+27*3,hero.pos2D.y+YposY+3+16,23,4,Draw.Color(0xFF339900));
				end;
			end;
		end
	...
	if TData.level > 0 then
		if TData.ammoCurrentCd > 0 then
			...
			if TData.currentCd > 0 then
				...
				Draw.Rect(hero.pos2D.x-XposX+121,hero.pos2D.y+YposY+3+16,23,4,Draw.Color(0xFF339900));
				end;
			end;
		end
	...
	local SpellYOffset = 0;
		if DData.ammoCurrentCd > 0 then
			...
			if DData.currentCd > 0 then
				...
				Draw.Rect(hero.pos2D.x-XposX+120+33-1, hero.pos2D.y+YposY+3+12-1,14,14,Draw.Color(0xFF339900));
				SpellYOffset = 228;
				end;
			end;
	...
	local SpellYOffset = 0;
		if FData.ammoCurrentCd > 0 then
			...
			if FData.currentCd > 0 then
				...
				Draw.Rect(hero.pos2D.x-XposX+120+33-1+16, hero.pos2D.y+YposY+3+12-1,14,14,Draw.Color(0xFF339900));
				SpellYOffset = 228;
				end;
			end;
			...
			if CAMenu.WaypointTracker.Enabled:Value() then
				...
				if hero.isEnemy then
					...
					if CAMenu.WaypointTracker.TAllies:Value() then
						Draw.Line(posTo2D.x,posTo2D.y,hero.pos2D.x,hero.pos2D.y,3,Draw.Color(0x10339900));
						if posTo2D.onScreen then
							if hero.posTo:DistanceTo(hero.pos) > 100 then
								if CAMenu.WaypointTracker.EPName:Value() then
									Draw.Text(hero.charName,12,posTo2D.x,posTo2D.y,Draw.Color(0x40339900));
									end
								if CAMenu.WaypointTracker.EPTime:Value() then
									Draw.Text(tostring(math.ceil(hero.posTo:DistanceTo(hero.pos)/hero.ms)),12,posTo2D.x,posTo2D.y+12,Draw.Color(0x40339900));
									end
								end
							end
						end
